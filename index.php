...
$qrCodeUrl = $Authenticator->getQR('EjercicioYeisonUMG', $_SESSION['auth_secret']);
...
<head>
    <meta charset="UTF-8">
    <title>Autenticación Con Google auten</title>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 offset-md-3"  style="background: white; padding: 20px; box-shadow: 10px 10px 5px #888888; margin-top: 100px;">
                <h1>Autenticación basada en el tiempo</h1>
                <p style="font-style: italic;">Un tipo de Autenticación de Google Authenticator</p>
                <hr>
                <form action="check.php" method="post">
                    <div style="text-align: center;">
                        <?php if ($_SESSION['failed']): ?>
                            <div class="alert alert-danger" role="alert">
                                        <strong>Oh!</strong> Codigo Invalido.
                            </div>
                            <?php   
                                $_SESSION['failed'] = false;
                            ?>
                        <?php endif ?>
                            ...
                            <input type="text" class="form-control" name="code" placeholder="******" maxlength="6" style="font-size: xx-large;width: 200px;border-radius: 0px;text-align: center;display: inline;color: #0275d8;"><br> <br>    
